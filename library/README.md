...
```groovy
dependencies {
    implementation 'com.github.jimblackler.jsonschematypes:jsonschemafriend:0.7.9'
...
[here](https://javadoc.jitpack.io/com/github/jimblackler/jsonschematypes/jsonschemafriend/0.7.9/javadoc/net/jimblackler/jsonschemafriend/package-summary.html).
